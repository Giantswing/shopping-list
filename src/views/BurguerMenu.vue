...
<template>
  <div class="absolute top-0 left-0 z-50 w-full h-full overflow-hidden pointer-events-none">
    ...
    <div class="m-3 absolute left-0 top-16 z-10 flex flex-col gap-3 pointer-events-auto">
      ...
      <div class="w-[48px] h-[48px] flex flex-col items-center justify-center opacity-50">
        <p v-if="useBasket.offlineMode" class="text-center font-semibold text-xs text-gray-600">Offline</p>
