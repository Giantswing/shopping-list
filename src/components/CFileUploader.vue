    ...
    if (file.type.includes("image") && minimumResolution.width && minimumResolution.height) {
      ...
      img.onload = () => {
        ...
        if (width < minimumResolution.width || height < minimumResolution.height) {
          toast.error(
            `File ${file.name} does not meet the minimum resolution of ${minimumResolution.width}x${minimumResolution.height}`
          );
          resolve(true);
        } else {
          resolve(false);
    ...
    >
      ...
      <div class="w-full flex justify-between items-center">
        ...
        <div class="flex gap-2">
          <MintyButton class="bg-red-500 hover:!bg-red-700 text-white" :link="'https://www.iloveimg.com/compress-image'">
            Compress
          </MintyButton>
          <MintyButton class="bg-red-500 hover:!bg-red-700 text-white" :link="'https://www.iloveimg.com/resize-image'">
            Resize
          </MintyButton>
        </div>
      </div>
